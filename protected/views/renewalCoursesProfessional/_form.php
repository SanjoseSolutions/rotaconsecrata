<?php
/* @var $this RenewalCoursesProfessionalController */
/* @var $model RenewalCoursesProfessional */
/* @var $form CActiveForm */
?>

<?php
$action = $model->isNewRecord ?
	array('/renewalCoursesProfessional/create') :
	array('/renewalCoursesProfessional/update', 'id'=>$model->id);
$form=$this->beginWidget('CActiveForm', array(
	'id'=>'professionalRenewalCourses-form',
	...
	<?php
		...
		echo $form->numberField($model,'year',array(
			'min' => ($yr-100),
			'max' => $yr,
			'value'=>($model->year?$model->year:$yr)
		));
