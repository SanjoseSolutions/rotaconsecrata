...
class Members extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('province_id, father_alive, mother_alive, mission, generalate, updated_by,
				...
				num_nuns, place_family, convent_decease, donate_organs, donate_eyes,
        donate_heart, donate_kidneys, donate_liver, donate_pancreas, donate_body,
        donate_lungs', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
        ...
        'donate_body' => 'Entire Body',
        'donate_eyes' => 'Eyes',
        'donate_liver' => 'Liver',
        'donate_kidneys' => 'Kidneys',
        'donate_heart' => 'Heart',
        'donate_lungs' => 'Lungs',
        'donate_pancreas' => 'Pancreas',
			),
