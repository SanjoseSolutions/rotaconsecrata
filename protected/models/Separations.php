 ...
 *
 * The followings are the available columns in table 'separations':
 * @property integer $id
 ...
 */
class Separations extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('nature', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, year_from, year_to, nature, member_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Separations the static model class
	 */
